  ...
  return (
    <Html center>
      {placeholderSrc ? (
        ...
        <div style={{ color: 'var(--precision-cyan)', fontFamily: 'var(--font-mono)', fontSize: '14px' }}>
...
const ModelInner = ({
  ...
  useLayoutEffect(() => {
    ...
    outer.current.rotation.set(initPitch, initPitch, 0); // Fixed from initPitch, initYaw to use both
